...
public class VideoPlayerPlugin implements FlutterPlugin, AndroidVideoPlayerApi {
  ...
  @Override
  public List<Messages.GetEmbeddedSubtitlesMessage> getEmbeddedSubtitles(@NonNull Long playerId) {
    VideoPlayer player = getPlayer(playerId);
  ...
  public ArrayList<String> getAudioTracks(@NonNull Long playerId)
  {
    VideoPlayer player = getPlayer(playerId);
    return player.getAudioTracks();

  }
  public void setAudioTrack(@NonNull Messages.TrackMessage  arg)
  {
    VideoPlayer player = getPlayer(arg.getPlayerId());
    player.setAudioTrack(arg.getTrackName().toString());
  }

  public void setAudioTrackByIndex(@NonNull Messages.TrackMessage arg)
  {
    VideoPlayer player = getPlayer(arg.getPlayerId());
    player.setAudioTrackByIndex(arg.getIndex().intValue());
  }

  public ArrayList<String> getVideoTracks(@NonNull Long playerId)
  {
    VideoPlayer player = getPlayer(playerId);
    return player.getVideoTracks();

  }
  public void setVideoTrack(@NonNull Messages.TrackMessage arg)
  {
    VideoPlayer player = getPlayer(arg.getPlayerId());
    player.setVideoTrack(arg.getTrackName().toString());
  }

  public void setVideoTrackByIndex(@NonNull Messages.TrackMessage arg)
  {
    VideoPlayer player = getPlayer(arg.getPlayerId());
